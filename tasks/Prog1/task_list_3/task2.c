// 2) Fazer um programa que gere aleatoriamente a produção (120 a 350) e a
// linha de produção (1 ou 2) de 50 operários a calcule a média de produção
// geral e de cada linha.
...
void
gen_avg (int prod[], int line[], float avg[], float *total_avg)
{
  size_t i;
  int sum[MAXLINE] = { 0 };
  int accum_sum = 0;

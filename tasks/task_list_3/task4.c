...
// (12 a 17)e o esporte preferido (1 – Basquete, 2 – Futebol ou 3 – Vôlei) de
// um grupo de 75 jovens e calcule: a média de idade dos jovens que preferem
// cada esporte e a média das idades dos meninos e das meninas.
...
int
gen_avg (Jovem *j, float sportAvg[], float sportGend[])
{
  size_t i;
  int sumSport[3] = { 0 };
  int totalSport[3] = { 0 };

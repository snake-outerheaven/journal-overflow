// 8) Um hospital está fazendo um estudo referente um conjunto de 100 pacientes
// atendidos em sua emergência, para isso faça um programa que gere
// aleatoriamente o tipo de atendimento(0– Clinica Geral ou 1 – Ortopedia) a
// origem (0 – Particular ou 1 – Plano de Saúde) e a idade dos pacientes(0-
// 90). Calcule o percentual de atendimentos de cada tipo, a média de idade dos
// pacientes de cada origem e o percentual de pacientes da Clínica geral com
// idade superior a 60 ano.

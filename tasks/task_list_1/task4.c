...
// lados de um triângulo, caso afirmativo, classifique o triângulo quanto ao
// seu tipo.
...
// retorna 1 se o triângulo for equilátero, 2 se o triângulo for isósceles, 3
// se o triângulo for escaleno, 0 se não for válido
